...
A connector to retrieve your [La Nef] bank accounts and operations.
...
La Nef Konnector is developed by @carrieje and distributed under the [AGPL v3 license][agpl-3.0].
